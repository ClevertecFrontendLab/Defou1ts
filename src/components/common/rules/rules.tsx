...
export const Rules = () => (
    <React.Fragment>
        <Htag tag='h3'>Правила пользования</Htag>
        <Text className={styles.subtitle} type='subtitle' size='l'>
        ...
        <Text className={styles.firstLevel} type='body' size='l'>
        ...
        <Text className={styles.secondLevel} type='body' size='l'>
        ...
        <Text className={styles.thirdLevel} type='body' size='l'>
